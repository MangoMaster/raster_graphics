...
int main()
{
    ...
    fillPolyScanLine(img, const_vertices, n_vertices, n_contours, cv::Scalar(255, 0, 0));
    cv::fillPoly(img_example, const_vertices, n_vertices, n_contours, cv::Scalar(255, 0, 0));
